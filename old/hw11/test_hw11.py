...
class Test(unittest.TestCase):
    ...
    def test09(self):
        ...
        self.assertEquals(d2.diff(d1), 37)
        self.assertEquals(d1.diff(d2), -37)
        d1 = date.Date(11, 9, 2011)
        d2 = date.Date(5, 18, 2012)
        self.assertEquals(d2.diff(d1), 191)
        self.assertEquals(d1.diff(d2), -191)
        d1 = date.Date(11, 9, 2011)
        self.assertEquals(d1.diff(date.Date(1, 1, 1899)), 41219)
        self.assertEquals(d1.diff(date.Date(1, 1, 2101)), -32560)

    def test10(self):
        self.assertEquals(date.Date(12, 7, 1941).dow(), 'Sunday')
        self.assertEquals(date.Date(10, 28, 1929).dow(), 'Monday')
        self.assertEquals(date.Date(10, 19, 1987).dow(), 'Monday')
        self.assertEquals(date.Date(1, 1, 2100).dow(), 'Friday')
        self.assertEquals(date.Date(2, 26, 1979).dow(), 'Monday')
        self.assertEquals(date.Date(10, 12, 2013).dow(), 'Saturday')
        self.assertEquals(date.Date(2, 11, 2015).dow(), 'Wednesday')
        self.assertEquals(date.Date(5, 19, 2015).dow(), 'Tuesday')
        self.assertEquals(date.Date(5, 14, 2015).dow(), 'Thursday')
